"""
early_science_planning_customconstraint.py
...
Notes: uses custom MoonSkyBrightnessConstraint instead of combo of built in MoonSeparationConstraint and MoonIlluminationConstraint
...
from astroplan import Constraint, AirmassConstraint, AtNightConstraint
...
constraints = [AirmassConstraint(2, ), AtNightConstraint.twilight_civil()]#, MoonSeparationConstraint(min=45*u.deg)] #remove MoonSeparationConstraint and MoonIlluminationConstraint in favor of MoonSkyBrightnessConstraint
...
class MoonSkyBrightnessConstraint(Constraint):
    """
    Constraint on the additional sky brightness from the moon calculated via separation and illumination
    """
...
wb.save("EarlyScienceObservability_custom_constraint.xlsx")
